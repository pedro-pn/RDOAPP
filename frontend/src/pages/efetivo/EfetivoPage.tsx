...
import { listPlanningJobRoles, type MissionScheduleStatus, type MissionStage } from '../../api/efetivoPlanning';
      ...
      <main className="page-scroll equip-page efetivo-page">
        <div className="equip-layout">
          ...
          <section className="equip-content" data-efetivo-content>
            ...
            {section === 'visao-geral' ? <OverviewBoard date={date} jobRoleId={jobRoleId} /> : null}
            ...
            {section === 'colaboradores' ? <><CollaboratorsBoard date={date} jobRoleId={jobRoleId} search={search} canManage={canManage} onSearchChange={value => updateParam('search', value || undefined)} /><AbsencesBoard canManage={canManage} /></> : null}
