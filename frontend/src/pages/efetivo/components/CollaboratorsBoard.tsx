...
export function CollaboratorsBoard({ date, jobRoleId, search, canManage, onSearchChange }: {
  date: string;
  jobRoleId?: string;
  search: string;
  canManage: boolean;
