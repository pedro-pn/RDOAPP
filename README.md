...
- **Webhook de projetos**: recebe número, nome, cliente, CNPJ, contrato e local em `POST /api/webhooks/projects`, protegido por `PROJECT_INTAKE_WEBHOOK_TOKEN`. O projeto entra destacado e aguarda verificação manual do gestor.
