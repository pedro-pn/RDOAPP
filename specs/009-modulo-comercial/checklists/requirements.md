...
| Menu de entrada × diálogo de modo | FR-043 | **Os dois passos coexistem**, sem atalho. Preserva o fluxo da referência e mantém a lista fechada em 20 desvios. O diálogo não reaparece quando o modo já vem no endereço (FR-044) |
...
- **Escopo além do porte**: as decisões da §12.5 (permissões, autoria, cadastro de
  ...
  lista fechada de 20 desvios, porque aquela lista trata de paridade de UI/UX e estas
