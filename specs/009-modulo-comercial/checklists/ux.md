...
- [ ] CHK026 - O SC-003 exige "zero divergências fora dos 16 desvios". Existe critério escrito para **classificar** uma divergência como desvio aprovado ou defeito, ou isso fica a critério do revisor? [Measurability, Spec §SC-003]
