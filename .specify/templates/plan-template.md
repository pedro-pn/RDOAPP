...
|---------|----------------------------|--------------------------|-------------------------------|------------------------|------------------------|----------------------------------|
| [surface name] | [path + pattern checked] | [e.g., Modal, Button, field-group, admin-inline-form] | [default/focus/disabled/error/empty, including required-empty red highlight] | [URL/query params or N/A with reason] | [10-day novelty/tutorial or N/A with reason] | [viewport behavior; tabs/cards/grids/text overflow checked] |
